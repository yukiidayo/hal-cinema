        ...
        <div className='mb-8 flex flex-col gap-3'>
            ...
            <div className='flex items-center gap-4'>
                <div className='flex items-center gap-2'>
                    <button
                        onClick={onClearAll}
                        className={`rounded-full px-5 py-1.5 text-sm font-bold transition border ${
                ...
                <div className='flex items-center gap-4 text-sm'>
                    <span className='text-muted-foreground font-bold'>並べ替え:</span>
                    <div className='flex items-center gap-4'>
                        <button
            ...
            {/* 下段: 検索ボックス + 表示切替 */}
            <div className='flex items-center gap-4 rounded-xl bg-muted/60 p-4 border border-border'>
